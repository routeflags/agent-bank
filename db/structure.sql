...
CREATE TABLE `ai_models` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `index_ai_models_on_ai_provider_id_and_slug` (`ai_provider_id`,`slug`),
...
CREATE TABLE `credit_transactions` (
  ...
  `updated_at` datetime(6) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `index_credit_transactions_on_wallet_id` (`wallet_id`),
...
CREATE TABLE `listing_ai_models` (
  ...
  `updated_at` datetime(6) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `index_listing_ai_models_on_listing_id_and_ai_model_id` (`listing_id`,`ai_model_id`),
  UNIQUE KEY `index_listing_ai_models_on_listing_id_default_unique` (`listing_id`),
...
CREATE TABLE `user_plan_subscriptions` (
  ...
  `updated_at` datetime(6) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `index_user_plan_subscriptions_on_status` (`status`),
  KEY `index_user_plan_subscriptions_on_stripe_subscription_id` (`stripe_subscription_id`),
